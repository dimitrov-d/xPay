                    ...
                    <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                      ...
                      <div className="text-left min-w-0 flex-1">
                        ...
                        <div className="text-xs sm:text-sm text-muted-foreground font-normal">
                          ...
                          {server.endpoints.length === 1 ? "tool" : "tools"}{" "}
                          available
                        </div>
                      </div>
                    </div>
                    <Badge variant="secondary" className="mr-1 sm:mr-2 text-xs flex-shrink-0">
                      {server.endpoints.length}
                    </Badge>
                  </div>
                  <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50 border">
                    <code className="flex-1 text-xs break-all font-mono text-left overflow-hidden">
                      {server.mcpUrl}
                    </code>
                    <div
                      role="button"
                      tabIndex={0}
                      className="shrink-0 h-6 w-6 sm:h-7 sm:w-7 flex items-center justify-center rounded-md hover:bg-accent hover:text-accent-foreground cursor-pointer transition-colors"
                      onClick={(e) => {
                        e.stopPropagation();
